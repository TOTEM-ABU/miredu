            ...
            <div className="user-menu-container" style={{ position: 'relative' }}>
              ...
              >
                <div className="user-avatar">
                  <img
                    src={user.avatar || 'https://ui-avatars.com/api/?name=' + encodeURIComponent(user.firstName || user.name || 'U') + '&background=6366f1&color=fff'}
                    alt="Avatar"
                  />
                </div>
                <div>
                  <div style={{ fontWeight: 800, fontSize: '0.875rem', color: '#f1f5f9' }}>{user.firstName || user.name || 'User'}</div>
              ...
              {showProfileMenu && (
                <div style={{
                  ...
                  backdropFilter: 'blur(12px)', borderRadius: '0.75rem', padding: '0.5rem',
                  ...
                  <Link 
                    ...
                    style={{
                      ...
                      color: '#e2e8f0', textDecoration: 'none', fontSize: '0.85rem', fontWeight: 600,
                      borderRadius: '0.5rem', cursor: 'pointer', transition: 'all 0.2s',
                    }}
                    onMouseEnter={e => Object.assign(e.currentTarget.style, { background: 'rgba(99,102,241,0.15)', color: 'var(--primary)' })}
                    onMouseLeave={e => Object.assign(e.currentTarget.style, { background: 'transparent', color: '#e2e8f0' })}
                  >
                  ...
                  <button 
                    ...
                    style={{
                      ...
                      borderRadius: '0.5rem', cursor: 'pointer', background: 'none', border: 'none',
