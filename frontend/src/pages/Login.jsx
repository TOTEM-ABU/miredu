          ...
          <form onSubmit={onSubmit}>
            <div className="field-group">
              ...
              <div className="field-wrap">
                ...
                <input name="email" type="email" required className="field-input" placeholder="misol@mail.com" onChange={onChange} />
              </div>
            </div>
            ...
            <button type="submit" disabled={loading} className="btn-primary">
              {loading ? <Loader2 size={20} style={{ animation: 'spin 1s linear infinite' }} /> : <><LogIn size={18} /> Tizimga Kirish</>}
            </button>
          </form>

          <p style={{ textAlign: 'center', marginTop: '2rem', fontSize: '0.875rem', color: '#475569', fontWeight: 600 }}>
            Hisobingiz yo'qmi?{' '}
            <Link to="/register" className="link-primary" style={{ marginLeft: '0.25rem' }}>
              Ro'yxatdan o'tish
            </Link>
          </p>
        </div>
