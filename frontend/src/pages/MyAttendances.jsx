...
export default function MyAttendances() {
  ...
  const fetchAttendances = async () => {
    ...
    try {
      ...
      const { data } = await api.get(
        `/api/attendance/student/${user.id}?limit=200`,
      );
  ...
  const strokeDashoffset =
    circumference - (ratePercentage / 100) * circumference;
      ...
      <AnimatePresence mode="wait">
        {loading ? (
          ...
          >
            ...
            >
              Sizda davomat tarixi yo'q
            </h3>
            <p
              style={{ color: "#94a3b8", fontSize: "1.05rem", fontWeight: 500 }}
            >
              Siz hali darslarga qatnashishni boshlamagansiz.
            </p>
          </motion.div>
        ) : (
          <motion.div
          ...
          >
            ...
            <div className="attendance-grid top-grid">
              ...
              <div
                className="content-card stat-hero-card"
                style={{
                  display: "flex",
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <motion.circle
                      ...
                      style={{
                        strokeLinecap: "round",
                        dropShadow: `0 0 10px ${ratePercentage > 85 ? "rgba(16,185,129,0.5)" : "rgba(245,158,11,0.5)"}`,
                      }}
                    />
                  </svg>
                  <div
                ...
                >
                  ...
                  >
                    {ratePercentage > 85
                      ? "Juda yaxshi intizom, barakalla!"
                      : ratePercentage > 60
                        ? "Muntazamlikni oshiring"
                        : "Davomat holati yomon"}
                  </span>
                </div>
              </div>
            ...
            >
              ...
              >
                ...
                <div style={{ flex: "1 1 500px" }}>
                  ...
                  {filteredData.length === 0 ? (
                    ...
                    >
                      ...
                      >
                        Ushbu filtr bo'yicha tarix topilmadi.
                      </div>
                    </div>
                  ) : (
                    <motion.div
                ...
                <div
                  style={{ width: "100%", maxWidth: "280px", flexShrink: 0 }}
                >
